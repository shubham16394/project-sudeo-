...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
       ...
       <div class="heading">
       <img src="gamesfolder/04JOSVj.jpg" class="game" width="182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Volition Inc.</div>Publisher:<div class="info" >Deep Silver</div>Genre:<div class="info" >Action</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >21 January 2015</div>Media Size:<div class="info">4.4 GB</div>System Requirements:<div class="info">Intel Core i3-2100T 2.5 GHz/AMD Phenom II X4 3.4 GHz, 
4GB RAM, GeForce GTX 560/Radeon HD 6800, 10 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
       </pre>
       </div>
       </div>
       <div class="heading">
       <img src="gamesfolder/LKugKsM.jpg" class="game" style="width:182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Sledgehammer Games</div>Publisher:<div class="info" >Activision Blizzard</div>Genre:<div class="info" >Shooter</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >4 November 2014</div>Media Size:<div class="info">26 GB</div>System Requirements:<div class="info">Intel Core i5 3.30 GHz, 8GB RAM,GeForce GTX 760 4 GB, 
55 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
</pre>
</div>
<div class="info" style="background:rgba(255,255,255,0.9);color:black;width:80px;padding-left:8px;border-radius:10px;position:relative;top:-250px;left:1000px"><a href="games6.php" style="text-decoration:none;color:black">Next&nbsp;&nbsp;<img src="gamesfolder/arrow2 - Copy.png"/><img src="gamesfolder/arrow2 - Copy.png"/></a></div>
</div>
</div>
</div>
</div>
