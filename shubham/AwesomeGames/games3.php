...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
       ...
       <div class="heading">
       <img src="gamesfolder/i2C5IQSpt6Zyw.jpg" class="game"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >BioWare Corporation</div>Publisher:<div class="info" >Electronic Arts Inc.</div>Genre:<div class="info" >RPG</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >14 December 2014</div>Media Size:<div class="info">17 GB</div>System Requirements:<div class="info">Intel Quad Core 3.0 GHz/AMD Six Core 3.2 GHz,8GB 
RAM, GeForce GTX 660/Radeon R9 270, 26 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
       </pre>
       </div>
       </div>
       <div class="heading">
       <img src="gamesfolder/iTIs7xXYWhFE8.jpg" class="game" style="width:182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Ubisoft Studios</div>Publisher:<div class="info" >Ubisoft</div>Genre:<div class="info" >Action</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >17 November 2014</div>Media Size:<div class="info">12.4 GB</div>System Requirements:<div class="info">Intel Core i5-750 2.6 GHz/AMD Phenom II X4 955 3.2 GHz,
4GB RAM,GeForce GTX 460/Radeon HD 5850, 30 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
</pre>
</div>
<div class="info" style="background:rgba(255,255,255,0.9);color:black;width:80px;padding-left:8px;border-radius:10px;position:relative;top:-250px;left:1000px"><a href="games4.php" style="text-decoration:none;color:black">Next&nbsp;&nbsp;<img src="gamesfolder/arrow2 - Copy.png"/><img src="gamesfolder/arrow2 - Copy.png"/></a></div>
</div>
</div>
</div>
</div>
