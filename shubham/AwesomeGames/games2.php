...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
       ...
       <div class="heading">
       <img src="gamesfolder/0CAuwwq.jpg" class="game"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >NetherRealm Studios</div>Publisher:<div class="info" >Warner Bros Interactive Entertainment</div>Genre:<div class="info" >Fighting</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >16 April 2015</div>Media Size:<div class="info">18 GB</div>System Requirements:<div class="info">Intel Core i5-750 2.67 GHz/AMD Phenom II 965 3.4 GHz,3GB 
RAM, 1GB GeForce 460/2 GB Radeon 5850, 25 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
       </pre>
       </div>
       </div>
       <div class="heading">
       <img src="gamesfolder/ibadntHRYLo28y.png" class="game" style="width:182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Dimps Corporation</div>Publisher:<div class="info" >Bandai Namco Entertainment</div>Genre:<div class="info" >Fighting</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >27 February 2015</div>Media Size:<div class="info">9 GB</div>System Requirements:<div class="info">Intel Core i3-530 2.93 GHz/AMD Phenom II X4 940 3.0 GHz,
4GB RAM,GeForce GTX 550 Ti/Radeon HD 6790, 10 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
</pre>
</div>
<div class="info" style="background:rgba(255,255,255,0.9);color:black;width:80px;padding-left:8px;border-radius:10px;position:relative;top:-250px;left:1000px"><a href="games3.php" style="text-decoration:none;color:black">Next&nbsp;&nbsp;<img src="gamesfolder/arrow2 - Copy.png"/><img src="gamesfolder/arrow2 - Copy.png"/></a></div>
</div>
</div>
</div>
</div>
