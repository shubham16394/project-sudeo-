...
<head>
<meta charset="utf-8">
<title>Awesome Games- Contact Us</title>
<link rel="icon" 
      type="image/png" 
...
.heading{height:400px;width:800px;font-family:Microsoft Sans Serif;color:white;position:relative;top:-1275px;left:0px;margin:0 auto;font-size:23px;background:rgba(0,0,0,0.3);line-height:30px;padding-top:10px}
...
<div class="main"><div class="mid"><img src="8903508-metal-gear-rising-revengeance.jpg" style="height:700px;width:1364px"/>
<div class="m">
...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
        ...
        <div class="mid3"><ul class="list"><li class="item" style="color:#999"><a id="0" href="AwesomeGames.php" style="text-decoration:none;color:#999" onMouseOver="fn5()" onMouseOut="fn5()">HOME</a></li><li class="item"><a href="games.php" id="1" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn1()" onMouseOut="fn1()">GAMES</a></li><li class="item"><a href="myfavourites.php" id="2" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn2()" onMouseOut="fn2()">MY FAVOURITES</a></li><li class="item"><a href="aboutus.php" id="3" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn3()" onMouseOut="fn3()">ABOUT US</a></li><li class="item"><a href="contact.php" id="4" style="margin-top:0;margin-bottom:0;text-decoration:none;color:white" >CONTACT US</a></li><li class="item"><a href="support.php" id="5" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn4()" onMouseOut="fn4()" >SUPPORT</a></li><form><li class="item" id="x" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999;cursor:pointer" onMouseOver="fnx()" onMouseOut="fnx()" value="logout" >LOG OUT</li></form></ul></div>
        
       </div> <div class="log" style="text-decoration:none;color:#06F">Hi, <?php echo $_SESSION["myname"];?> </div>
       <div class="heading"><p style="margin:0 auto;margin-left:25px">My Contact Details</p>
       <div style="height:300px;width:700px;margin:0 auto;position:relative;top:20px"><img src="phone.png" height="20px" style="position:relative;top:30px;left:100px;"/><pre style="font-family:Microsoft Sans Serif;color:white;font-size:20px;position:relative;top:-23px;left:150px">Contact No. -    8576866137, 8285779998</pre>
       <img src="google.png" height="30px" style="position:relative;top:0px;left:100px;"/><pre style="font-family:Microsoft Sans Serif;color:white;font-size:20px;position:relative;top:-55px;left:150px"> Email          -     shubham16394@gmail.com</pre>
       <img src="facebook.png" height="35px" style="position:relative;top:-30px;left:100px;"/><pre style="font-family:Microsoft Sans Serif;color:white;font-size:20px;position:relative;top:-90px;left:150px"> Facebook   -     www.facebook.com/shubhamt644</pre>
