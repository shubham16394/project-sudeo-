...
<head>
<meta charset="utf-8">
<title>Awesome Games- My Favourites</title>
<link rel="icon" 
      type="image/png" 
...
.heading{height:600px;width:1000px;font-family:Microsoft Sans Serif;color:white;position:relative;top:-1375px;left:0px;margin:0 auto;font-size:23px;background:rgba(0,0,0,0.5);line-height:30px;padding-top:10px}
...
<div class="main"><div class="mid"><img src="[CooL GuY] {{a2zRG}} (61).jpg" style="height:700px;width:1364px"/>
<div class="m">
...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
        ...
        <div class="mid3"><ul class="list"><li class="item" style="color:#999"><a id="0" href="AwesomeGames.php" style="text-decoration:none;color:#999" onMouseOver="fn5()" onMouseOut="fn5()">HOME</a></li><li class="item"><a href="games.php" id="1" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn1()" onMouseOut="fn1()">GAMES</a></li><li class="item"><a href="myfavourites.php" id="2" style="margin-top:0;margin-bottom:0;text-decoration:none;color:white" >MY FAVOURITES</a></li><li class="item"><a href="aboutus.php" id="3" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn3()" onMouseOut="fn3()">ABOUT US</a></li><li class="item"><a href="contact.php" id="4" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn2()" onMouseOut="fn2()" >CONTACT US</a></li><li class="item"><a href="support.php" id="5" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999" onMouseOver="fn4()" onMouseOut="fn4()" >SUPPORT</a></li><form><li class="item" id="x" style="margin-top:0;margin-bottom:0;text-decoration:none;color:#999;cursor:pointer" onMouseOver="fnx()" onMouseOut="fnx()" value="logout">LOG OUT</li></form></ul></div>
        
       </div> <div class="log" style="text-decoration:none;color:#06F">Hi, <?php echo $_SESSION["myname"];?> </div>
       <div class="heading"><p style="margin:0 auto;margin-left:25px;font-weight:bold;font-size:36px">My Favourite Games - Give them a try</p>
       <ul><li>Middle Earth - Shadow of Mordor</li><li>Grand Theft Auto 5</li><li>Max Payne 3</li><li>Dragon Ball Xenoverse</li><li>Devil May Cry - Latest Edition</li><li>Devil May Cry 4 - Special Edition</li><li>Call of Duty - Modern Wallfare 3</li><li>Battlefield 3</li><li>Assassin Creed 3</li><li>Assassin Creed 4 - Black Flag</li><li>Assassin Creed Rogue</li><li>Metal Gear Rising Revengence</li><li>Crysis 2</li><li>Crysis 3</li><li>Witcher 3 - Wild Hunt</li><li>Mortal Combat X</li><li>Injustice - Gods Among Us</li></ul>
       </div>
       </div>
