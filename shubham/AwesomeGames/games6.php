...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
       ...
       <div class="heading">
       <img src="gamesfolder/i2cCpT0byzfqh.jpg" class="game" width="182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Ubisoft Studios</div>Publisher:<div class="info" >Ubisoft</div>Genre:<div class="info" >Action</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >14 November 2014</div>Media Size:<div class="info">28 GB</div>System Requirements:<div class="info">Intel Core i5-2500T 3.3 GHz/AMD FX-8350 3.3 GHz, 
6GB RAM, GeForce GTX 680/Radeon HD 7970, 50 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
       </pre>
       </div>
       </div>
       <div class="heading">
       <img src="gamesfolder/k85cQ4j.png" class="game" style="width:182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Gearbox Software</div>Publisher:<div class="info" >Gearbox Software</div>Genre:<div class="info" >Strategy</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >27 February 2015</div>Media Size:<div class="info">7.7 GB</div>System Requirements:<div class="info">Intel Quad Core 2.3 GHz, 4GB RAM,GeForce GTX 560 
1GB/Radeon 5850, 20 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
</pre>
</div>
<div class="info" style="background:rgba(255,255,255,0.9);color:black;width:80px;padding-left:8px;border-radius:10px;position:relative;top:-250px;left:1000px"><a href="games.php" style="text-decoration:none;color:black">Next&nbsp;&nbsp;<img src="gamesfolder/arrow2 - Copy.png"/><img src="gamesfolder/arrow2 - Copy.png"/></a></div>
</div>
</div>
</div>
</div>
