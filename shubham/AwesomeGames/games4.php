...
<script type="text/javascript" src="jssor.core.js"></script>
	...
	$(document).ready(function() {
       ...
       <div class="heading">
       <img src="gamesfolder/fnI6ebW.jpg" class="game"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Frogwares</div>Publisher:<div class="info" >Focus Home Interactive</div>Genre:<div class="info" >Adventure</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >30 September 2014</div>Media Size:<div class="info">4 GB</div>System Requirements:<div class="info">Intel Core 2 Duo 2.4 GHz, 2GB RAM, GeForce 8600 
256 MB, 14 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
       </pre>
       </div>
       </div>
       <div class="heading">
       <img src="gamesfolder/Dbm4jPz.jpg" class="game" style="width:182px"/>
       <div class="subheading"><pre style="font-family:Microsoft Sans Serif;color:#6F0;font-size:18px;margin-top:-5px;font-weight:bold">Developer:<div class="info" >Creative Assembly</div>Publisher:<div class="info" >SEGA</div>Genre:<div class="info" >Survival Horror</div>Platform:<div class="info" >PC</div>Release Date:<div class="info" >6 October 2014</div>Media Size:<div class="info">8.83 GB</div>System Requirements:<div class="info">Intel Core 2 Quad 3 GHz, 8GB RAM,GeForce GTX 660 
2 GB, 35 GB HDD</div>Download:<div class="info" style="font-size:20px;color:#FF0"><a href="#" ><img src="c-finger-pointing.png" height="40px"/></a></div>
</pre>
</div>
<div class="info" style="background:rgba(255,255,255,0.9);color:black;width:80px;padding-left:8px;border-radius:10px;position:relative;top:-250px;left:1000px"><a href="games5.php" style="text-decoration:none;color:black">Next&nbsp;&nbsp;<img src="gamesfolder/arrow2 - Copy.png"/><img src="gamesfolder/arrow2 - Copy.png"/></a></div>
</div>
</div>
</div>
</div>
