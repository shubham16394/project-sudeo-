...
cp=load_parser('grammars/book_grammars/best_movie.fcfg')
query=qu.lower()
...
if w==None:
	print """
		...
		window.location="../shubham/AwesomeGames/QAhtml/best_movie.html"
		</script>
	"""
	

else:
	trees = list(cp.parse(['which','movie','was','best_movie','in',w]))
