...
if w==None:
	...
	trees = list(cp.parse(['which','person','was','best_actress','in',w]))
	...
	z=x[1]
	z=z.upper()
	kk="The best actress in "+ w +" was " + y + "for movie" + z
	db.close()
...
.mid3{height:200px;width:700px;margin:0 auto;position:relative;top:0px;overflow:auto}
