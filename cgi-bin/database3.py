...
cp=load_parser('grammars/book_grammars/myfile2.fcfg')
query=qu.lower()
#import capital_question
#from capital_question import check
#query=check(query)
import que 
from que import match
w=match(query)
if w==None:
	print """
		<script type="text/javascript">
		alert("Entered Question is wrong, Please enter a valid Question");
		window.location="../shubham/AwesomeGames/QAhtml/pm.html"
		</script>
	"""
	

else:
	trees = list(cp.parse(['which','person','is','president','of',w]))
...
.mid3{height:100px;width:700px;margin:0 auto;border:2px solid white;position:relative;top:10px}
...
<div class="main"><img src="../shubham/AwesomeGames/QAhtml/download-wall-world-map-of-the-countries-6446.jpg" style="height:650px;width:1300px">
