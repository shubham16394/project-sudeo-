...
cp=load_parser('grammars/book_grammars/best_director.fcfg')
query=qu.lower()
...
if w==None:
	print """
		...
		window.location="../shubham/AwesomeGames/QAhtml/best_director.html"
		</script>
	"""
	

else:
	trees = list(cp.parse(['which','person','was','best_director','in',w]))
	...
	z=x[1]
	z=z.upper()
	kk="The best director in "+ w +" was " + y + "for movie" + z
	db.close()
