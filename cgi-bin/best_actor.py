...
cp=load_parser('grammars/book_grammars/best_actor.fcfg')
query=qu.lower()
...
if w==None:
	print """
		...
		window.location="../shubham/AwesomeGames/QAhtml/best_actor.html"
		</script>
	"""
	

else:
	trees = list(cp.parse(['which','person','was','best_actor','in',w]))
	...
	z=x[1]
	z=z.upper()
	kk="The best actor in "+ w +" was " + y + "for movie" + z
	db.close()
