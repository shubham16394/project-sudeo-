...
if w==None:
	print """
		...
		window.location="../shubham/AwesomeGames/QAhtml/capital.html"
		</script>
	"""
	

else:
	trees = list(cp.parse(['which','city','is','capital','of',w]))
...
.mid3{height:100px;width:700px;margin:0 auto;border:2px solid white;position:relative;top:50px;overflow:auto}
